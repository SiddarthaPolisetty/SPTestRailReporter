...
typedef NS_ENUM(NSInteger, SPTestRailSuiteMode) {
    SPTestRailSuiteModeSingleSuite = 1,
    SPTestRailSuiteModeSingleSuitePlusBaseLines,
    SPTestRailSuiteModeMultipleSuites
};

@interface SPTestRailProject : JSONModel
